        ...
        <div className="flex items-center h-20 gap-6">
          ...
          >
            ...
            <div className="flex flex-col leading-tight">
              {/* BUSINESS NAME (shared mobile + desktop) */}
              <span
              ...
              {/* MOBILE "CONSTRUCTIONS" (only shows below sm) */}
              <span
                className="uppercase sm:hidden"
                style={{
                  color: '#29ABE2',
                  letterSpacing: '0.9em',   // ← tweak MOBILE width here
                  fontSize: '0.52rem',      // ← tweak MOBILE size here
                  lineHeight: '1rem',
              ...
              {/* DESKTOP "CONSTRUCTIONS" (only shows sm and up) */}
              <span
                className="uppercase hidden sm:inline-block"
                style={{
                  color: '#29ABE2',
                  letterSpacing: '1.28em',  // ← tweak DESKTOP width here
                  fontSize: '0.6rem',      // ← tweak DESKTOP size here
                  lineHeight: '1rem',
